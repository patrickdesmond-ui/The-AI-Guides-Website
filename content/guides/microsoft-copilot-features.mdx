...
Microsoft upgraded Copilot with a long-context model—over one million tokens, which is tech-speak for "you can throw a 300-page tender document at it and it'll actually read the whole thing."
